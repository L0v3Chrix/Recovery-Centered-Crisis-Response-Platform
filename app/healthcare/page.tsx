...
// Import healthcare resources from database
import { healthcareResources } from '@/data/all-resources-database'
...
export default function HealthcarePage() {
  ...
  const filteredResources = healthcareResources.filter(resource => {
  ...
  return (
    <div className="min-h-screen bg-soft-cream-50">
      ...
      <div className="bg-hope-mint-400 text-white py-4 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-2xl font-bold mb-2">🏥 Healthcare Resources ({healthcareResources.length})</h1>
          <p className="text-white/90">Medical care, mental health crisis support, and wellness services</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search within healthcare resources..."
              className="w-full pl-10 pr-4 py-3 border border-warm-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-hope-mint-400/20 focus:border-hope-mint-400"
              value={searchTerm}
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          <div className="flex items-center gap-2">
            ...
            <button className="px-3 py-1 bg-white border border-warm-slate-200 rounded-full text-sm hover:border-hope-mint-300 transition-colors">
              Crisis
            </button>
            <button className="px-3 py-1 bg-white border border-warm-slate-200 rounded-full text-sm hover:border-hope-mint-300 transition-colors">
              24/7
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <select 
              className="px-3 py-1 bg-white border border-warm-slate-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-hope-mint-400/20"
              value={selectedSort}
        ...
        <div className="space-y-4">
          {filteredResources.map((resource) => {
            ...
            return (
              <div key={resource.id} className="bg-white rounded-lg border border-warm-slate-200 hover:border-hope-mint-300 transition-all duration-200">
                {/* Main Card Content */}
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-hope-mint-600 font-medium text-sm mb-2">
